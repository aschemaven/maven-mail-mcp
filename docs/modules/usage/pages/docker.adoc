...
Profile:: `analysis` (start with `docker compose --profile analysis up -d kibana`)
Features::
...
They will automatically restart when Docker restarts, unless explicitly stopped.
====
...
Start it with: `docker compose --profile analysis up -d kibana`
====
